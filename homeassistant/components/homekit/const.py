...
# CHAR_LOCK_PHYSICAL_CONTROLS valid values
LOCK_PHYSICAL_DISABLED = 0
LOCK_PHYSICAL_ENABLED = 1
PROP_LOCK_PHYSICAL_DISABLED = "ControlLockDisabled"
PROP_LOCK_PHYSICAL_ENABLED = "ControlLockEnabled"
PROP_LOCK_PHYSICAL_VALID_VALUES = {
    PROP_LOCK_PHYSICAL_DISABLED: LOCK_PHYSICAL_DISABLED,
    PROP_LOCK_PHYSICAL_ENABLED: LOCK_PHYSICAL_ENABLED
}

# LOCK_SWING_MODE_DISABLED valid values
LOCK_SWING_MODE_DISABLED = 0
LOCK_SWING_MODE_ENABLED = 1
PROP_SWING_MODE_DISABLED = "SwingDisabled"
PROP_SWING_MODE_ENABLED = "SwingEnabled"
PROP_SWING_MODE_VALID_VALUES = {
    PROP_SWING_MODE_DISABLED: LOCK_SWING_MODE_DISABLED,
    PROP_SWING_MODE_ENABLED: LOCK_SWING_MODE_ENABLED
}
